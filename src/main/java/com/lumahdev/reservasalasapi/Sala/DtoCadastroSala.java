...
public record DtoCadastroSala (
        ...
        @NotNull(message = "Capacidade é obrigatória.") @Positive(message = "Capacidade deve ser um número positivo.") @Min(value = 1, message = "Capacidade deve ser maior que 1.") int capacidade,
